          ...
          <div className="bg-gray-800 rounded-2xl max-w-lg w-full p-4 sm:p-6 my-auto max-h-[95vh] overflow-y-auto relative">
            ...
            {recordedVideo ? (
              ...
              <>
                ...
                <button
                  onClick={() => setShowVideoModal(false)}
                  className="w-full py-2.5 sm:py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold"
                >
                  ตกลง
                </button>
              </>
                ...
                <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-2 mb-4">
                      <MuscleMap exercise="squat" view="front" size="md" />
                      <MuscleMap exercise="squat" view="back" size="md" />
                    </div>
